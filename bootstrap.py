...
<div class="setup-step" id="step2">
  ...
  <div class="setup-row">
    <input class="setup-input" id="rmaFolder" placeholder="Browse to RMAJobLogger folder..." readonly>
...
<div class="setup-step" id="step3">
  ...
  <div class="setup-row">
    <input class="setup-input" id="reportsFolder" placeholder="Browse to folder..." readonly>
